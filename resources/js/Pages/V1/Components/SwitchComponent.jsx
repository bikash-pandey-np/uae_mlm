                        ...
                        {Object.values(fetchMarketData).map((crypto) => (
                            <tr key={crypto.id} className='hover:cursor-pointer hover:bg-red-200'>
                                ...
                                <td className="px-4 py-2">
                                    <a href={route('v1.trade', ['crypto', getSlug(crypto)])} className="bg-white text-blue-500 border border-blue-500 hover:bg-blue-500 hover:text-white py-1 px-4 rounded text-sm">
                                        Trade
                                    </a>
                                </td>
                            </tr>
                    ...
                    <tbody>
                        {Object.values(fetchShareData).map((share) => (
                            <tr key={share.id} className='hover:cursor-pointer hover:bg-red-200'>
                                ...
                                <td className="px-4 py-2">
                                    <a href={route('v1.trade', ['shares', getSlugS(share)])} className="bg-white text-blue-500 border border-blue-500 hover:bg-blue-500 hover:text-white py-1 px-4 rounded text-sm">
                                        Trade
                                    </a>
                                </td>
                            </tr>
