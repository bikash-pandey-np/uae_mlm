...
const CreateInfo = () => {
    ...
    // Update currency if type is changed
    useEffect(() => {
        if (data.type === "flat") {
            setData({
                ...data,
    ...
    }, [data.type, data.wallet_address]);

    // Update type if currency is changed
    useEffect(() => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log("ready to submit data", data);
        post(route('admin.create.deposit-info'), data)
    };
    ...
    return (
        <Layout>
            <PageHeader
                title="Create Deposit Payment Info"
                buttonLabel="Back"
            ...
            <form onSubmit={handleSubmit} className="mt-4 w-2/3 mx-auto">
                    ...
                    <div className="grid grid-cols-3 gap-6">
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setData("flat_account_name", e.target.value)
                                }
                            />
                        </div>
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setData("flat_bank_name", e.target.value)
                                }
                            />
                        </div>
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setData("flat_account_no", e.target.value)
                                }
                            />
                        </div>
                    </div>
                ...
                <div className="mb-4">
                    ...
                    <textarea
                        ...
                        onChange={(e) =>
                            setData("deposit_instruction", e.target.value)
                        }
                    />
                </div>
                <button
